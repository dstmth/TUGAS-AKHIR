...
<div class="container">
    ...
    <form action="{{ route('pegawai.update', $pegawai->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="KodePegawai" placeholder="KodePegawai" required
                    value="{{ $pegawai->kodepegawai }}" oninvalid="this.setCustomValidity('Isi - jika tidak tau')"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="Nama" placeholder="Nama" required="required"
                    value="{{ $pegawai->nama }}" oninvalid="this.setCustomValidity('Nama tidak boleh kosong')"
                    oninput="setCustomValidity('')">
            </div>
        </div>
        </--------------------------------------------------------Alamat-----------------------------------------------------------------------------------* />
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select name="Kelamin" class="form-control" value="{{ $pegawai->kelamin }}" required
                    oninvalid="this.setCustomValidity('pilih salah satu...')" oninput="setCustomValidity('')">
                    <option selected value="">pilih...</option>
                    <option value="laki-laki" {{ $pegawai->kelamin == 'laki-laki' ? 'selected' : '' }}>Laki-laki
                    </option>
                    <option value="perempuan" {{ $pegawai->kelamin == 'perempuan' ? 'selected' : '' }}>Perempuan
                    </option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="number" class="form-control" id="notelp" name="Telepon"
                    placeholder="Nomer Telepon (aktif WhatsApp)" value="{{ $pegawai->telepon }}" required
                    oninvalid="this.setCustomValidity('isi 0 jika tidak tau')" oninput="setCustomValidity('')">
            </div>
        </div>
        ...
        <div class="form group row">
            ...
            <div class="col-sm-3">
                <select name="Agama" class="form-control" required
                    oninvalid="this.setCustomValidity('agama tidak boleh kosong')" oninput="setCustomValidity('')">
        ...
        <div class="form group row">
            ...
            <div class="col-sm-3">
                ...
                <select name="Jabatan" class="form-control" required
                    oninvalid="this.setCustomValidity('pilih - jika tidak tau')" oninput="setCustomValidity('')">
                    <option selected value="">pilih...</option>
                    ...
                    <option value="Bendahara" {{ $pegawai->jabatan == 'Bendahara' ? 'selected' : '' }}>Bendahara
                    </option>
