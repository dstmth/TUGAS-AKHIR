                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">
                            <img src="{{ asset('img/Logoklinik.png') }}" style=”float:left;
                                width="55";height="55"” />klinik bidan sri usisa
                        </h5>
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-sm">
                                    <select name="layanan" class="form-control " required
                                        oninvalid="this.setCustomValidity('pilihkan layanan yang digunakan pasien...')"
                                        oninput="setCustomValidity('')">
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-sm">
                                    <textarea type="text" name="keluhan" class="form-control" cols="30" rows="5"
                                        ...
                                        oninvalid="this.setCustomValidity('isi keluhan pasien...')" oninput="setCustomValidity('')"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mt-2">
                                ...
                                <div class="col-sm">
                                    <select name="doktor" class="form-control " required
                                        oninvalid="this.setCustomValidity('pilihkan dokter yang memeriksa...')"
                                        oninput="setCustomValidity('')">
