...
<div class="container">
    ...
    <form action="{{ route('pegawai.store') }}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="KodePegawai" placeholder="Kode Pegawai..."
                    value="{{ old('KodePegawai') }}" required oninvalid="this.setCustomValidity('Isi - jika tidak ada')"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="Nama" placeholder="Nama" required="required"
                    value="{{ old('Nama') }}" oninvalid="this.setCustomValidity('Nama tidak boleh kosong')"
                    oninput="setCustomValidity('')">
            </div>
        </div>
        </--------------------------------------------------------Alamat-----------------------------------------------------------------------------------* />
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="Alamat" placeholder="Alamat"
                    value="{{ old('Alamat') }}" required oninvalid="this.setCustomValidity('Isi - jika tidak tau')"
                    oninput="setCustomValidity('')">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select name="Kelamin" value="{{ old('Kelamin') }}" class="form-control" required
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="number" class="form-control" id="notelp" name="Telepon"
                    placeholder="Nomer Telepon (aktif WhatsApp)" value="{{ old('Telepon') }}" required
        ...
        <div class="form group row">
            ...
            <div class="col-sm-3">
                <select name="Agama" class="form-control @error('Agama') is-invalid @enderror">
                    ...
                    <option value="protestan" {{ old('Agama') != 'protestan' ?: 'selected' }}>Kristen Protestan
                    </option>
        ...
        <div class="form group row">
            ...
            <div class="col-sm-3">
                <select name="Jabatan" class="form-control" required
                    oninvalid="this.setCustomValidity('pilih jabatan...')" oninput="setCustomValidity('')">
                    <option selected value="">pilih...</option>
