...
// $mappp = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.81658214372!2d109.31363747614968!3d-0.053482399945984874!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e1d596cd7dd8adf%3A0x70f513859ad3b868!2sGg.%20Kapuas%20Melawi%2C%20Kota%20Baru%2C%20Kec.%20Pontianak%20Sel.%2C%20Kota%20Pontianak%2C%20Kalimantan%20Barat!5e0!3m2!1sid!2sid!4v1694352442352!5m2!1sid!2sid';
$mappp ="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d249.35862967101468!2d108.96182551441726!3d0.36338954744360497!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31e2f19aab06e41b%3A0x6989414f2588bb86!2sJl.%20Bawal%20No.60%2C%20Terusan%2C%20Kec.%20Mempawah%20Hilir%2C%20Kab.%20Mempawah%2C%20Kalimantan%20Barat%2078912!5e0!3m2!1sid!2sid!4v1694443682944!5m2!1sid!2sid";
?>
...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/Logoklinik.png" href="assets/favicon.ico" />
    ...
    <link href="{{ asset('img/Logoklinik.png') }}" rel="SHORTCUT ICON" />
</head>
...
<body id="page-top" onload="initClock()">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="{{ asset('img/Logoklinik.png') }}" style=”float:left;
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="img/Logoklinik.png" alt="..." />
            <!-- Masthead Heading-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Mempawah</p>
        </div>
    </header>
    <!--------------------------------------------------------Bagian Isi Konten----------------------------------------------------------------------------------->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                        ...
                        <img class="img-fluid" src="img/lobby klinik.JPG" alt="..." style="width: 500px" />
                    </div>
                </div>
                <!-- Portfolio Item 2-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
                        ...
                        <img class="img-fluid" src="img/rawat inap .JPG" alt="..." style="width: 500px" />
                    </div>
                </div>
                <!-- Portfolio Item 3-->
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal3">
                        ...
                        <img class="img-fluid" src="img/ruang periksa.JPG" alt="..." style="width: 500px" />
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                        Jl.Bawal 2, No. 2
                        <br />
                        Kecamatan Mempawah Hilir, Kabupaten Mempawah , Kalimantan Barat - Indonesia
                    </p>
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="col-lg-4">
                    ...
                    <p class="lead mb-0">
                        Klinik {{ env('APP_NAME') }} dibangun sejak tahun ... yang berada di kecamatan Mempawah Hilir -
                        Kalimantan Barat
                    </p>
                </div>
            </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Ruang Rawat
                                </h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                ...
                                <img class="img-fluid rounded mb-5" src="img/rawat inap .JPG" alt="..."
                                    style="width: 700px" />
                ...
                <div class="modal-body text-center pb-5">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- Portfolio Modal - Title-->
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Ruang Periksa
                                </h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img class="img-fluid rounded mb-5" src="img/ruang periksa.JPG" alt="..."
                                    style="width: 700px" />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">======</p>
                                <button class="btn btn-primary" data-bs-dismiss="modal">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-sm">
                                <input type="text" class="form-control" id="notelp" name="Telepon"
                                    placeholder="Nomer Telepon (aktif WhatsApp)"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">
                            <img src="{{ asset('img/Logoklinik.png') }}" style=”float:left;
