...
<div class="container">
    ...
    <form action="tambahpasien" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control @error('Telepon') is-invalid @enderror" id="notelp"
                    name="Telepon" placeholder="Nomer Telepon (aktif WhatsApp)" value="{{ old('Telepon') }}">
                @error('Telepon')
                    <div class="invalid-feedback">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <select name="Pendidikan" class="form-control @error('Pendidikan') is-invalid @enderror">
                    <option value="-">-</option>
                    <option value="sltp/sd-smp" {{ old('Pendidikan') != 'sltp/sd-smp' ?: 'selected' }}>SLTP / SD-SM
                    </option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control @error('Pekerjaan') is-invalid @enderror" name="Pekerjaan"
                    placeholder="Isi '-' jika belum/tidak bekerja " value="{{ old('Pekerjaan') }}">
                @error('Pekerjaan')
                    <div class="invalid-feedback">
        ...
        <div class="form-group row mt-2">
            ...
            <div class="col-sm-3">
                <select name="layanan" class="form-control " required oninvalid="this.setCustomValidity('pilih...')"
                    oninput="setCustomValidity('')">
        ...
        <div class="form-group row mt-2">
            ...
            <div class="col-sm-5">
                <textarea type="text" name="RekamMedis" class="form-control" cols="30" rows="5"
                    placeholder="Masukkan keluhan si pasien, dan sudah berapa lama?" required
                    oninvalid="this.setCustomValidity('isi...')" oninput="setCustomValidity('')"></textarea>
            </div>
        </div>
