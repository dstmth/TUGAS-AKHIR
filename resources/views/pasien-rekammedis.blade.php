...
<div class="container">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" name="Kodepasien" placeholder="Kodepasien" required="required"
                value="{{ $pasien->kodepasien }}"readonly>
        </div>
    </div>
    </--------------------------------------------------------Alamat-----------------------------------------------------------------------------------* />
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" name="Pekerjaan" placeholder="Isi '-' jika belum/tidak bekerja "
                value="{{ $pasien->pekerjaan }}"readonly>
        </div>
    </div>
            ...
            <tbody>
                ...
                @foreach ($rekam as $row)
                    <tr>
                        ...
                        <td>{{ $row->rawat ?? '-' }}</td>
                        <td>{{ $row->darah ?? '-' }}</td>
                        <td>{{ $row->hari_pertama_haid ?? '-' }}</td>
                        <td>{{ $row->hari_terakhir_haid ?? '-' }}</td>
                        ...
                        <td>{{ $row->pinggang ?? '-' }} Cm</td> --}}
                            ...
                            -----------------------------------------------------------------------------------* />
                        <td class="text-sm">
                            <a href="editrekam/{{ $row->id }}" class="btn btn-warning" data-bs-toggle="tooltip"
            ...
            <form action="/rekam-store" method="post">
                ...
                <div class="modal-body relative p-4">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm">
                            <select name="layanan" class="form-control " required
                                oninvalid="this.setCustomValidity('Pilih Layanan...')"
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm">
                            <textarea type="text" name="keluhan" class="form-control" cols="30" rows="5"
                                placeholder="isi keluhan pasien, dan sudah berapa lama?" required
                                oninvalid="this.setCustomValidity('Isi keluhan si pasien')" oninput="setCustomValidity('')"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm">
                            <select name="dokter" class="form-control " required
                                oninvalid="this.setCustomValidity('Pilih Dokter yang memeriksa')"
                                oninput="setCustomValidity('')">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <select name="obat" id="" class="form-control" required
                                oninvalid="this.setCustomValidity('Pilih Obatnya dahulu..')"
                                oninput="setCustomValidity('')">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="number" class="form-control" name="jumlahobat" placeholder="Jumlah obat"
                                ...
                                oninvalid="this.setCustomValidity('isi 0 jika tidak diberikan obat')"
                                oninput="setCustomValidity('')">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="keterangan" placeholder="Keterangan.."
                                ...
                                oninvalid="this.setCustomValidity('Isi - Jika kosong')"
                                oninput="setCustomValidity('')">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Hari Pertama Haid</label>
                        <div class="col-sm-5">
                            <input type="date" class="form-control" name="hari_pertama_haid"
                                value="{{ old('hari_pertama_haid') }}" required
                                oninvalid="this.setCustomValidity('Isi - Jika kosong')"
                                oninput="setCustomValidity('')">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Hari Terakhir Haid</label>
                        <div class="col-sm-5">
                            <input type="date" class="form-control" name="hari_terakhir_haid"
                                value="{{ old('hari_terakhir_haid') }}" required
                                oninvalid="this.setCustomValidity('Isi - Jika kosong')"
                                oninput="setCustomValidity('')">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Taksiran Persalinan</label>
                        <div class="col-sm-5">
                            <input type="date" class="form-control" name="taksiran_persalinan"
                                value="{{ old('taksiran_persalinan') }}" required
                                oninvalid="this.setCustomValidity('Isi - Jika kosong')"
                                oninput="setCustomValidity('')">
                        </div>
                    </div>
            ...
            <form action="/update-pasien" method="post">
                ...
                <div class="modal-body relative p-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="Kodepasien" placeholder="Kodepasien"
                                required="required" value="{{ $pasien->kodepasien }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <select name="Kelamin" class="form-control " required
                                ...
                                <option value="laki-laki" {{ $pasien->kelamin == 'laki-laki' ? 'selected' : '' }}>
                                    Laki-laki</option>
                                <option value="perempuan"{{ $pasien->kelamin == 'perempuan' ? 'selected' : '' }}>
                                    Perempuan</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="notelp" name="Telepon"
                                placeholder="Nomer Telepon (aktif WhatsApp)" value="{{ $pasien->telepon }}">
                        </div>
                    </div>
                    ...
                    <div class="form group row">
                        ...
                        <div class="col-sm-3">
                            <select name="Agama" class="form-control" required
                                ...
                                <option value="islam" {{ $pasien->agama == 'islam' ? 'selected' : '' }}>Islam
                                </option>
                                <option value="protestan" {{ $pasien->agama == 'protestan' ? 'selected' : '' }}>
                                    Kristen
                                    Protestan
                                </option>
                                <option value="katolik" {{ $pasien->agama == 'katolik' ? 'selected' : '' }}>Kristen
                                    Katolik
                                </option>
                                <option value="hindu" {{ $pasien->agama == 'hindu' ? 'selected' : '' }}>Hindu
                                </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <select name="Pendidikan" class="form-control ">
                                <option value="-">-</option>
                                <option value="sltp/sd-smp"
                                    {{ $pasien->pendidikan == 'sltp/sd-smp' ? 'selected' : '' }}>SLTP / SD-SMP</option>
                                <option value="slta/sma" {{ $pasien->pendidikan == 'slta/sma' ? 'selected' : '' }}>
                                    SLTA / SMA</option>
                                <option value="sarjana" {{ $pasien->pendidikan == 'sarjana' ? 'selected' : '' }}>
                                    Sarjana</option>
                            </select>
                        </div>
                    </div>
