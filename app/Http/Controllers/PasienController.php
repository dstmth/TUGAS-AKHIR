...
class PasienController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (count($data) > 0) {
            ...
            Rekam::create([
                ...
                // 'hari_terakhir_haid' =>$request->hari_terakhir_haid,
    ...
    public function rekamstore(Request $request)
    {
        ...
        Rekam::create([
            ...
            'hari_terakhir_haid' => $validated['hari_terakhir_haid'],
            'taksiran_persalinan' => $validated['taksiran_persalinan'],
        ]);
