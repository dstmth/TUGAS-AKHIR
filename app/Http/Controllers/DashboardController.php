...
class DashboardController extends Controller
{
    ...
    public function updaterekam(Request $request)
    {
        ...
        $rekam->hari_pertama_haid = $request->hari_pertama_haid;
        $rekam->hari_terakhir_haid = $request->hari_terakhir_haid;
        $rekam->taksiran_persalinan = $request->taksiran_persalinan;
        $rekam->save();
